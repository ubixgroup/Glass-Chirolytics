...
# user study also ignores airports: IKA, KIX, BLR, CAN, CTU (to balance POINTS_OF_INTEREST, for other script)
...
def generate_solution_flights():
    ...
    for solution in config["solution_destinations"]:
        ...
        # decoy 6: near-budget flight (just slightly over user 1's limit)
